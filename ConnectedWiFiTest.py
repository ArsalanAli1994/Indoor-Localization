...
if __name__ == '__main__':
    ...
    while True:
        ...
        for iface in ifaces:
            ...
            for network in networks:
                SSIDs=network.dot11Ssid.SSID[:network.dot11Ssid.SSIDLength].decode()
                        #Wqualitys=network.wlanSignalQuality
                if SSIDs==ssidTrackName:
                    Wqualitys=network.wlanSignalQuality
        print(Wqualitys)                         
